...
public class Tren_inferior extends Indumentaria {
	...
	public void ubicacion() {
		super.ubicacion();
		System.out.println("Ya adentro, estoy en el segundo piso en el costado de la izquierda :v");
	}
	public Tren_inferior(String nombre, int precio, int id, String color, String talla,String genero, String horma, boolean diseno_solido, String mangas) {
